...
Second, we rank the gene expression in normal tissue sample (i.e. `the data_ctrl_f matrix`)
...
For each gene in line (PYCR2, TTC7A, etc.), we can see the number of L and H genes.
...
<span style="color:red">Note: you can use the vignette `"vignette_simulation"` to adjust the parameters to your data.</span>
