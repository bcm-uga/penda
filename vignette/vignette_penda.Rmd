...
First we filter the data to remove genes with very low expression. We used the function `normalmixEM` to define the threshold of low expression on all the datas normalized with a pseudo-log2.
