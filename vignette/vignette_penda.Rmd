...
p1_l0_sansu  = results_simulation(D_matrix_sansi, U_matrix_sansi, simulation, 1)
...
p2_l0_sansu  = results_simulation(D_matrix_sansi, U_matrix_sansi, simulation, 2)
...
p3_l0_sansu  = results_simulation(D_matrix_sansi, U_matrix_sansi, simulation, 3)
...
p4_l0_sansu  = results_simulation(D_matrix_sansi, U_matrix_sansi, simulation, 4)
...
p5_l0_sansu  = results_simulation(D_matrix_sansi, U_matrix_sansi, simulation, 5)
...
rf1 = function(p1) qf(runif(p1)) #randome variable
...
simu_v2 = function(data, threshold){
  simu_data = data
  sapply(data, function(g){
    if (g > 100){
     if (sample(1:100, 1) <= 22) {
      if (sample(1:100, 1) <= 30) {
        simu_data[g] = simu_data[g] * p1
      } else {
        simu_data[g] = simu_data[g] / p2
      }
    }
  } else if (sample(1:100, 1) <= 30) {
    if (sample (1:100,1) <= 50){
      simu_data[g] = simu_data[g] - p3
      if (simu_data[g] <= 0){
        simu_data[g] = 0
      }
    } else {
