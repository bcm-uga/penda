...
The three last patients are used to simulate deregulation data.
The function "detect_zero_value" allows to eliminate genes with more than 80% of expression equal to 0.
The processed data has 629 genes.
```{r, tidy=TRUE, tidy.opts=list(blank=FALSE, width.cutoff=55)}
ctrl_data = readRDS('~/projects/perso_DA/data_ctrl.rds')[1:1000,]
simu_data = ctrl_data[,96:98]
ctrl_data = ctrl_data[,-(96:98)]
