...
#'regulation_test(gene = rownames(ctrl_data)[1], D_U_ctrl, patient_genes = simulated_data$simulated_data, threshold = 0.1)
#'
#'@export

regulation_test = function(gene, D_U_ctrl, patient_genes, threshold){
...
#'ctrl_data = ctrl_data[,-ncol(ctrl_data)]
#'step0(ctrl_data, simulated_data, quant = 0.05)
#'
#'@export
